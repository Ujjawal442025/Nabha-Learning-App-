...
//Student Details Click
const aryan= document.querySelector(".btn1");
const ujjawal= document.querySelector(".btn2");
const sundaram= document.querySelector(".btn3");
aryan.addEventListener('click',()=>{
    alert("Assignment: 3,Test:85%,Overall:Good")
});
ujjawal.addEventListener('click',()=>{
    alert("Assignment: 2,Test:90%,Overall:Good")
});
sundaram.addEventListener('click', () => {
    alert("Assignment: 1,Test:75%,Overall:Good")
});
